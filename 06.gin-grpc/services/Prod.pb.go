...
const (
	ProdAreas_A ProdAreas = 0 // 第一个必须是 0 表示默认值
...
type ProdRequest struct {
	...
	ProdArea ProdAreas `protobuf:"varint,2,opt,name=prod_area,json=prodArea,proto3,enum=services.ProdAreas" json:"prod_area,omitempty"` // 传入商品区域
}
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x05, 0x0a, 0x01, 0x43, 0x10, 0x02, 0x32, 0xac, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53,
	...
	0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b, 0x73, 0x65, 0x72, 0x76, 0x69,
